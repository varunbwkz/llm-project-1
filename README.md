...
3. **Memory Issues with Large Documents**:
   - The system uses batch processing, but very large PDFs may cause memory issues.. **To be fair, i have tested with 1 document containing > 3700 pages and it still worked fine !!**__
